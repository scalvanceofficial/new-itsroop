            ...
            <div class="col-lg-12 d-flex align-items-stretch">
                <div class="card w-100">
                    ...
                    <div class="card-body border-top">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="title" id="title"
                                    placeholder="Enter title name here" value="{{ isset($blog) ? $blog->title : '' }}" />
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Write Slug here..." name="slug"
                                    id="slug" value="{{ isset($blog) ? $blog->slug : '' }}" />
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                <label for="blog-image" class="control-label col-form-label">
                                    Thumbnail Image<sup class="tcul-star-restrict text-danger">*</sup>
                                </label>
                                <div>
                                    <fieldset class="form-group">
                                        <input type="file" name="thumbnail_image" class="form-control" id="blog-image"
                                            placeholder="Please Select Photo" accept="image/*">
                                        <div id="thumbnail_image-error" style="color:red"></div>
                                    </fieldset>
                                    @if (isset($blog))
                                        <div class="mt-3">
                                            <img src="{{ asset(Storage::url($blog->thumbnail_image)) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    <fieldset class="form-group">
                                        <input type="file" name="main_image" class="form-control" id="blog-image"
                                            placeholder="Please Select Photo" accept="image/*">
                                        <div id="main_image-error" style="color:red"></div>
                                    </fieldset>
                                    @if (isset($blog))
                                        <div class="mt-3">
                                            <img src="{{ asset(Storage::url($blog->main_image)) }}" alt="Uploaded Image"
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    <label for="description" class="control-label col-form-label">Description 1</label>
                                    <textarea name="description_1" class="form-control cktextarea" rows="3" id="description"
                                        placeholder="Enter description here">{{ isset($blog) ? $blog->description_1 : '' }}</textarea>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    <label for="description" class="control-label col-form-label">Description 2</label>
                                    <textarea name="description_2" class="form-control cktextarea" rows="3" id="description"
                                        placeholder="Enter description here">{{ isset($blog) ? $blog->description_2 : '' }}</textarea>
                                    <div id="description_2-error" style="color:red"></div>
                                </fieldset>
                            </div>
                        </div>
                    </div>
