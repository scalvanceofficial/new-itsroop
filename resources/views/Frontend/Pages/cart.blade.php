                                ...
                                <tbody>
                                    @foreach ($carts as $cart)
                                        @php
                                            ...
                                            $sub_total += $cart_data['price'] * $cart->quantity;
                                        @endphp
                                        <tr class="tf-cart-item file-delete">
                                            <td class="tf-cart-item_product">
                                                <a href="{{ route('frontend.products.product-details', ['slug' => $cart->product->slug]) }}"
                                                    class="img-box">
                                                    <img src="{{ $cart_data['image'] }}" alt="img-product">
                                                </a>
                                                <div class="cart-info">
                                                    <a href="{{ route('frontend.products.product-details', ['slug' => $cart->product->slug]) }}"
                                                        class="cart-title link">{{ $cart->product->name }}
                                                    </a>
                                                    <div class="cart-meta-variant">{{ $cart_data['property_values'] }}</div>
                                                </div>
                                            </td>
                                                ...
                                                <div class="cart-quantity">
                                                    <div class="wg-quantity">
                                                        <span class="btn-quantity btndecrease"
                                                            ...
                                                            data-property-values='@json($cart->property_values)'>
                                            ...
                                            <td class="tf-cart-item_remove tf-variant-item-remove d-flex align-items-center"
                                                cart-data-title="Remove">
                                                <a class="remove-cart link remove remove-cart-btn text-danger"
                                                    title="Remove" data-id="{{ $cart->product_id }}"
                                                    data-property-values='@json($cart->property_values)'>
